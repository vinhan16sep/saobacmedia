...
window.tinymce.Resource.add("tinymce.plugins.emoticons", {
  ...
  woman_technologist: {
    keywords: [ "coder", "developer", "engineer", "programmer", "software", "woman", "human", "laptop", "" ],
  ...
  man_technologist: {
    keywords: [ "coder", "developer", "engineer", "programmer", "software", "man", "human", "laptop", "" ],
  ...
  keyboard: {
    keywords: [ "technology", "", "type", "input", "text" ],
